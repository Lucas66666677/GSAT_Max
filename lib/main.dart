...
import 'core/theme/lucirel_theme.dart';

const Color kAppBackground = LucirelColors.background;
const Color kSurfaceGlass = LucirelColors.surface;
const Color kSurfaceGlassStrong = LucirelColors.surfaceStrong;
const Color kGlassBorder = LucirelColors.border;
const Color kTextPrimary = LucirelColors.textPrimary;
const Color kTextSecondary = LucirelColors.textSecondary;
const Color kTextTertiary = LucirelColors.textTertiary;
const Color kNeonGreen = LucirelColors.primary;
const Color kElectricBlue = LucirelColors.secondary;
const Color kDangerRed = LucirelColors.danger;
...
class _GsatEnglishAppState extends ConsumerState<GsatEnglishApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp.router(
      ...
      theme: buildLucirelTheme(focusMode: isFocusMode),
    );
  }
}
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  const LucirelProductBrand(markSize: 64),
      ...
      body: AppPage(
        children: [
          const PageIntro(
            ...
            title: '設定新密碼',
            subtitle:
                'Use at least eight characters and keep it unique to GSAT Max.',
          ),
          const SizedBox(height: 18),
          if (_isComplete)
            CleanCard(
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const LucirelProductBrand(compact: true, markSize: 28),
...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Future<void> _contactSupport() {
    return _launchSupportEmail(
      subject: 'GSAT Max Support Request',
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => ShareCaptureService.shareBoundary(
                  ...
                  shareText: 'My GSAT English skill radar from GSAT Max.',
                ),
                icon: const Icon(
          ...
          Align(
            ...
            child: OutlinedButton.icon(
              onPressed: () => ShareCaptureService.shareBoundary(
                ...
                shareText: 'I mastered a GSAT English concept with GSAT Max.',
              ),
